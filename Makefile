ios:
	...
	@cat public/js/parks.js | sed 's/^.*@CORDOVA@.*$$/document.addEventListener("deviceReady", onReady, false);/' > public/js/parks-ios.js
...
android:
	...
	@cat public/js/parks.js | sed 's/^.*@CORDOVA@.*$$/document.addEventListener("deviceReady", onReady, false);/' > public/js/parks-android.js
